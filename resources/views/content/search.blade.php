			...
			<header class="border-bottom mb-4 pb-3">
				<div class="form-inline">
					...
					<div class="btn-group" role="group">
						<a
							href="http://localhost:8888/iShop/public/shop/fashion?sort=high_low"
							class="btn btn-sm btn-outline-primary"
							>High To Low</a
						>
						<a
							href="http://localhost:8888/iShop/public/shop/fashion?sort=low_high"
				...
				<div class="col-md-4">
					<figure class="card card-product-grid">
						<div class="img-wrap">
							...
							<a
								class="btn-overlay"
								href="{{ url('shop' . '/' . $product->cat_url . '/' . $product->url) }}"
